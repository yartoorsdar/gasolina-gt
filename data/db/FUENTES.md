...
| `anual_semilla.csv` | 2002 → 2019 anual | MEM `PRECIOS-SEMANALES-CIUDAD-DE-GUATEMALA-AGOSTO-2024-SC.pdf` (`data/raw/`), fila "Promedio" — modalidad **servicio completo** | Regular y Diésel: coinciden con el PDF en los 18 años (±Q0.01 de redondeo). Superior: NO coincide con ninguna columna del PDF (ni con ni sin aditivo) → sin verificar. Ojo: serie de servicio completo; 2020+ en el gráfico anual es autoservicio (se deja así a propósito: el foco del sitio es el precio actual). Error del propio MEM: Regular dic-2003 = Q25.92 (vecinos ≈ Q16) |
