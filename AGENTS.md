...
- Dashboard `agruparNoticias`: máx. 2 por tema es PREFERENCIA; luego rellena hasta 5 (antes quedaban 2-4). `traducirTituloEnEspañol` ya NO inventa frases por patrón: sin `titulo_es` muestra el título original.
